VERSION 5.00
Begin VB.Form frmJissekiDataRuiseki 
   ...
   End
End
Attribute VB_Name = "frmJissekiDataRuiseki"
...
'//2004/06/03 新規扱いした日付を保護者マスタ(CANWDT)に設定：金額「０」は新規としない
    ...
    sql = sql & " WHERE (CAITKB,CAKYCD,CAKSCD,CAHGCD) IN("
    sql = sql & "       SELECT FAITKB,FAKYCD,FAKSCD,FAHGCD "
...
Private Sub Form_Unload(Cancel As Integer)
    Set mForm = Nothing
    Set frmJissekiDataRuiseki = Nothing
    Call gdForm.Show
End Sub
