...
Begin VB.Form frmYoteiDataPrint 
   ...
   Begin VB.ComboBox cboSort 
      Height          =   300
      ItemData        =   "振替予定表(印刷).frx":0000
      Left            =   1980
      List            =   "振替予定表(印刷).frx":000D
   ...
   Begin imText6Ctl.imText txtStartDate 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "振替予定表(印刷).frx":00EF
      Key             =   "振替予定表(印刷).frx":010D
...
'//2007/06/12 解約者は「tfFurikaeYoteiData」に作成されないので「解約」は有り得ない！
    sql = sql & " DECODE(NVL(CAKYFG,0),0,NULL,1,'解約','其他') CAKYFGx," & vbCrLf
