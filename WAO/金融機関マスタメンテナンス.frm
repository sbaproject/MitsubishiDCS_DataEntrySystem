...
Begin VB.Form frmBankMaster 
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "金融機関マスタメンテナンス.frx":09B2
      Height          =   3410
      Left            =   420
      OleObjectBlob   =   "金融機関マスタメンテナンス.frx":09C9
      TabIndex        =   12
      TabStop         =   0   'False
      Top             =   3000
      Width           =   8325
...
'//                sql = sql & "   AND BAKSCD = '" & dyn.Fields("BAKSCD") & "'"
            ...
            If flgUpdate = True Then
                ...
                .Fields("BAUSID").Value = gdDBS.LoginUserName
...
'    Dim sql As String, dyn As OraDynaset, fld As Variant
    Dim sql As String, dyn As Object, fld As Variant
    Dim flgUpdate As Boolean, flgInsert As Boolean
    Dim ix As Integer
    ...
    With dyn
        Do Until .EOF()
            ...
            If flgUpdate = True Then
                ...
                .Fields("CAUSID").Value = gdDBS.LoginUserName
